...
const Phone: React.FC = () => {
  ...
  const { name, bio, links, imageData, image } = context;
      ...
      >
        <div className="p-8">
          {/* <article>
            {imageData && (
              <Image
                cloudName="pskinnertech"
                publicId={`https://res.cloudinary.com/pskinnertech/image/upload/v1680385276/${imageData.public_id}`}
